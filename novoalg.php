...
require_once  "includes/head.php"; 
	...
	$sqlalug = mysqli_query($conn,"INSERT INTO aluguel (id_livro,id_aluno,id_admin,dt_alu,dt_ent, entregue) VALUES ('$id_livro', '$id_aluno',1, '$dt_alu', '$dt_ent', 0)");
	$sqldisp = mysqli_query($conn,"UPDATE livros SET disp_livro = 0 WHERE cod_livro = $cod");
